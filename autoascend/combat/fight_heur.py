...
def melee_monster_priority(agent, monsters, monster):
    _, y, x, mon, _ = monster
    # hypothesis: avoiding bare-handed melee against contact-petrifying birds lets the
    # existing retreat/ranged planner preserve runs that would otherwise end instantly.
    if mon.mname in ('cockatrice', 'chickatrice') and agent.inventory.items.gloves is None:
        return -100
    ret = 1
