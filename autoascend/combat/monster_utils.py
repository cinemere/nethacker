...
# hypothesis: cockatrices must be fought at range because unarmed monks (and heroes
# whose weapon breaks or is unwielded) can be instantly petrified by a melee strike.
ONLY_RANGED_SLOW_MONSTERS = [
    'floating eye', 'blue jelly', 'brown mold', 'gas spore', 'acid blob',
