...
def consider_melee_only_ranged_if_hp_full(agent, monster):
    # hypothesis: keeping passive cold-damage monsters ranged-only prevents fragile heroes
    # from killing themselves on retaliation before the bot can track cold resistance.
    return False
