    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: Tourists that reach XL7 gain more progression by descending for richer floors
                # than by spending thousands more turns exposed to increasingly dangerous level-1 spawns.
