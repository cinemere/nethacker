    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: Tourists that reach XL7 gain more progression by descending to richer floors
                # than by surviving another long cycle of increasingly dangerous level-one monster spawns.
