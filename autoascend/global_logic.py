    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: Tourists that have survived to XL7 gain more progression by leaving the
                # depleted first floor for richer encounters than by spending thousands of turns farming XL8.
                first_level_target_xl = 7 if self.agent.character.role == Character.TOURIST else 8
                condition = lambda: self.agent.blstats.experience_level >= first_level_target_xl
