    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: Tourists gain more progression by leaving sparse dungeon level 1 at XL7,
                # after securing that XP milestone but before the long and dangerous grind to XL8.
                target_xl = 7 if self.agent.character.role == Character.TOURIST else 8
                condition = lambda: self.agent.blstats.experience_level >= target_xl
