    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: Tourists should leave level 1 at XL6 because the scarce low-level spawns no longer
                # justify exposing their weak melee kit to thousands of extra turns before progression begins.
                condition = lambda: self.agent.blstats.experience_level >= (
                    6 if self.agent.character.role == Character.TOURIST else 8
                )
