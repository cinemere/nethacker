    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: tourists that leave dungeon level 1 at XL3 can turn their starting
                # ranged kit into food and progression instead of starving during the XL8 grind.
                first_level_target_xl = 3 if self.agent.character.role == Character.TOURIST else 8
