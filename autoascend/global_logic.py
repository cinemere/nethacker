    ...
    def current_strategy(self):
        ...
        while 1:
            ...
            if self.milestone == Milestone.BE_ON_FIRST_LEVEL:
                # hypothesis: Tourists that reach XL7 gain more progression by starting normal descent
                # than by remaining on level 1 for the disproportionately long and lethal XL8 grind.
