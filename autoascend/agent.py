...
class Agent:
    ...
    def emergency_strategy(self):
        ...
        if (
                # hypothesis: quaffing healing at half health preserves enough
                # HP to survive the next ordinary hit, improving both roles'
                # early-game survival before prayer or retreat can happen.
