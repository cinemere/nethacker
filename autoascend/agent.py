...
class Agent:
    ...
    def emergency_strategy(self):
        ...
        if (
                ...
                # hypothesis: praying at WEAK rather than waiting for FAINTING gives the existing
                # safe-prayer recovery a turn buffer, preventing starvation deaths across food-poor runs.
